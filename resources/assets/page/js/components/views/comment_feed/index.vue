            ...
            <div class="media-body body-feed-item">
                ...
                <div class="sort-left div_select_subcate" layout="row" style="margin-left:5px" layout-align="space-between center">
                        ...
                        <el-select v-model="point_set" placeholder="Số điểm">
                            <el-option disabled label="5" value="5"></el-option>
                            <el-option disabled label="10" value="10"></el-option>
                            <el-option disabled label="15" value="15"></el-option>
                            <el-option disabled label="20" value="20"></el-option>
                      </el-select>
            ...
            <div class="col-md-12">
                <div class="row">
                    <div layout-gt-sm="row">
                      <label>Tiêu đề</label>
                        <el-input placeholder="Tiêu đề câu hỏi" v-model="title_question"></el-input>
