	...
	<div class="content-section" style="padding-bottom:120px">
	    ...
	    <form @submit.prevent="save" @keydown="errors.clear($event.target.name)">
	        ...
	        <div class="form-group">
                ...
                <img v-if="!create" class="img-posts-admin" :src="'/public/upload/posts/'+form.image">
      ...
      export default {
        ...
        data () {
          return {
            ...
            link: '/api/posts',
            redirect: 'AdminPendingPostsIndex',
            method: 'post',
            choseBrief: false,
            choseContent: false,
            displayBrief:'Show',
        ...
        beforeMount() {
        	if(this.$route.meta.mode == 'edit') {
        		this.title = 'Edit Pending Post',
        		this.link = '/api/pendingposts/'+this.$route.params.id,
        		this.method = 'put',
                this.create = false,
        ...
        methods: {
            fetchData() {
                ...
                }).catch(error => vm.$router.push({ name: 'AdminPendingPostsIndex' }))
            },
            parseTime(time) {
            ...
            save() {
                ...
                axios({
                    ...
                    if(response.data.saved) {
                        ...
                        vm.$router.push({ name: 'AdminPendingPostsIndex' })
                    }
