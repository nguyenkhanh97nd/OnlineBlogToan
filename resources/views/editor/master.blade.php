...
<head>
  ...
  <!-- jQuery -->
  <script type="text/javascript" src="/public/editor/js/jquery.min.js"></script>
    <!-- X-CSRF-TOKEN -->
  ...
  <!-- Bootstrap Core CSS -->
  <link href="/public/editor/css/app.css" rel="stylesheet">
...
<body>
  ...
  <script type="text/javascript" src="/public/editor/js/bootstrap.min.js"></script>
  

  <script type="text/javascript" src="/public/editor/js/app.js"></script>
